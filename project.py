...
def time_giver():
    now = datetime.now()
    current_time = now.strftime("%H:%M:%S") # strf-string format of time
...
def add_student():
    ...
    name_entry = Entry(add_std)
    name_entry.place(x=750, y=250)
    contact_entry = Entry(add_std)
    contact_entry.place(x=750, y=300)
    room_entry = Entry(add_std)
    room_entry.place(x=750, y=350)
    password_entry = Entry(add_std)
    password_entry.place(x=750, y=400)

    Button(add_std, text='Add', width=10, bg='#801213', fg="#f5f5f5", command=save_student).place(x=800, y=450)
...
Label(home, text='Under guidance of Tejas Sir').place(x=20, y=750)
Label(home, text='Created by Nens Merja,Darshan Zala,Sanket Dandlya,Aarsh Sevak').place(x=1220, y=750)
entries = StringVar()
button1 = Button(home, text='Scan', width=25, bg='#387cb0', fg="#f5f5f5", command=scan).place(x=660, y=200)
button2 = Button(home, text='Login', width=25, bg='#387cb0', fg="#f5f5f5", command=login).place(x=660, y=300)
button3 = Button(home, text='Close', width=25, bg='#387cb0', fg="#f5f5f5", command=home.destroy).place(x=660, y=400)
